<h1 class="text-h3 mb-5 ml-6 font-semibold">Privacy Policy</h1>
<section class="text-md font-regular space-y-4 overflow-hidden px-6">
	<h2 class="text-lg">1. Общие положения</h2>
	<ol class="space-y-4">
		<li>
			1.1 Настоящая политика обработки персональных данных составлена в соответствии с требованиями
			...
			безопасности персональных данных, предпринимаемые ИП Потапов Антон Васильевич (далее —
			Оператор).
		</li>
		<li>
		...
		<li>
			1.3 Настоящая политика Оператора в отношении обработки персональных данных (далее — Политика)
			применяется ко всей информации, которую Оператор может получить о посетителях веб-сайта
			https://aielts.ru.
		</li>
	</ol>
	<h2 class="text-lg">2. Основные понятия, используемые в Политике</h2>
	<ol class="space-y-4">
		<li>
		...
		<li>
			...
			определяемому Пользователю веб-сайта https://aielts.ru.
		</li>
		<li>
		...
		<li>2.10 Пользователь — любой посетитель веб-сайта https://aielts.ru.</li>
		<li>
	...
	<h2 class="text-lg">3. Основные права и обязанности Оператора</h2>
	<ol class="space-y-4">
		<li>
	...
	<h2 class="text-lg">4. Основные права и обязанности субъектов персональных данных</h2>
	<ol class="space-y-4">
		<li>
	...
	<h2 class="text-lg">5. Принципы обработки персональных данных</h2>
	<ol class="space-y-4">
	...
	<h2 class="text-lg">6. Цели обработки персональных данных</h2>
	<div class="overflow-x-scroll">
		<table class="w-full table-auto border-collapse border border-gray-200">
			<thead>
				<tr class="bg-transparent">
					<th class="border border-gray-200 px-4 py-2">Цель обработки</th>
					<th class="border border-gray-200 px-4 py-2">Персональные данные</th>
					<th class="border border-gray-200 px-4 py-2">Правовые основания</th>
					<th class="border border-gray-200 px-4 py-2">Виды обработки персональных данных</th>
				</tr>
			</thead>
			<tbody>
				<tr class="">
					<td class="border border-gray-200 px-4 py-2"
						>Продвижение товаров, работ, услуг на рынке</td
					>
					<td class="border border-gray-200 px-4 py-2">электронный адрес, номера телефонов</td>
					<td class="border border-gray-200 px-4 py-2"
						>обработка персональных данных осуществляется с согласия субъекта персональных данных на
						обработку его персональных данных</td
					>
					<td class="border border-gray-200 px-4 py-2"
						>сбор; запись; систематизация; накопление; хранение; уточнение (обновление, изменение);
						извлечение; использование; передача (предоставление, доступ); обезличивание;
						блокирование; удаление; уничтожение; распространение</td
					>
				</tr>
				<tr>
					<td class="border border-gray-200 px-4 py-2"
						>Предоставление возможности пользоваться сервисом тренировки устной части экзамена без
						цели идентификации и/или аутентификации пользователя</td
					>
					<td class="border border-gray-200 px-4 py-2"
						>Биометрические персональные данные данные голоса человека</td
					>
					<td class="border border-gray-200 px-4 py-2"
						>обработка персональных данных осуществляется с согласия субъекта персональных данных на
						обработку его персональных данных</td
				...
				<tr>
					<td class="border border-gray-200 px-4 py-2">Проведение статистического учета</td>
					<td class="border border-gray-200 px-4 py-2"
						>сведения, собираемые посредством метрических программ; а также: Дополнительные данные,
						получаемые при доступе к Сайту, включающие в себя данные о технических средствах
						(устройствах), технологическом взаимодействии с Сайтом (в т.ч. IP-адрес хоста, вид
						операционной системы пользователя, тип браузера, географическое положение, поставщик
						услуг Интернета, данные, полученные в результате доступа к камере, микрофону и т.п.
						устройств), и последующих действиях Пользователя на Сайте</td
					>
					<td class="border border-gray-200 px-4 py-2"
						>обработка персональных данных осуществляется с согласия субъекта персональных данных на
						обработку его персональных данных</td
	...
	<h2 class="text-lg">7. Условия обработки персональных данных</h2>
	<ol class="space-y-4">
		<li>
	...
	<ol class="space-y-4">
		...
		<li>
			...
			Оператора antptp@gmail.com с пометкой «Актуализация персональных данных».
		</li>
		<li>
			...
			электронный адрес Оператора antptp@gmail.com с пометкой «Отзыв согласия на обработку
			персональных данных».
		</li>
		<li>
			8.5. Вся информация, которая собирается сторонними сервисами, в том числе платежными
			системами, средствами связи и другими поставщиками услуг, хранится и обрабатывается указанными
		...
		<li>
			8.7. Оператор при обработке персональных данных обеспечивает конфиденциальность персональных
			данных.
		</li>
		<li>
		...
		<li>
			...
			отзыв согласия субъектом персональных данных или требование о прекращении обработки
	...
	<h2 class="text-lg">10. Трансграничная передача персональных данных</h2>
	<ol class="space-y-4">
		<li>
			10.1. Оператор до начала осуществления деятельности по трансграничной передаче персональных
			данных обязан уведомить уполномоченный орган по защите прав субъектов персональных данных о
			своем намерении осуществлять трансграничную передачу персональных данных (такое уведомление
	...
	<h2 class="text-lg">11. Конфиденциальность персональных данных</h2>
	<ol class="space-y-4">
		<li>
	...
	<h2 class="text-lg">12. Заключительные положения</h2>
	<ol class="space-y-4">
		<li>
