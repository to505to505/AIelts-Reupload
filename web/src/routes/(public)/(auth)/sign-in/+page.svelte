...
<form onsubmit={signin} class="mx-auto flex flex-col px-6">
	...
	<div class="mx-6 mb-4">
		<Button disabled={!email || !password} className="w-full text-white" variant="solid">
			Continue with email
		</Button>
	</div>
	...
	<p class="pt-12 text-center">
		<a href="/sign-up">
			...
			<span class="ml-1 font-semibold underline">Sign Up</span>
		</a>
	</p>
</form>
